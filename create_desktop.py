...
def install_method():
    ...
    with open("/home/"+holder+"/Downloads/Password_Engine-main/password_engine.desktop", "w") as file:
...
def uninstall_method():
    ...
    with open("/home/"+holder+"/Downloads/Password_Engine-main/uninstall_linux.sh", "w") as file:
        file.write(text_sequence)
